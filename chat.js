...
else if(inputText.toLowerCase().indexOf("how to")>-1&&inputText.toLowerCase().indexOf("lifeguard")>-1||inputText.toLowerCase().indexOf("what")>-1&&inputText.toLowerCase().indexOf("lifeguard")>-1&&inputText.toLowerCase().indexOf("need")>-1){
