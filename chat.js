...
else if(inputText.toLowerCase().indexOf("breathing")>-1&&inputText.toLowerCase().indexOf("check")>-1||inputText.toLowerCase().indexOf("breathing")>-1&&inputText.toLowerCase().indexOf("how")>-1){document.getElementById("answer").innerHTML=`.(SLSS manual)`;}
//s4-resuscitation***
//s5-emergency care*
